...
## Easy
<div class="problems_problem_content__Xm_eO" bis_skin_checked="1"><p><span style="font-size:18px">Given a binary matrix&nbsp;of dimensions&nbsp;&nbsp;with&nbsp;<strong>M</strong> rows and <strong>N</strong> columns. Start from&nbsp;<strong>cell(0, 0)</strong>, moving in the&nbsp;<strong>right</strong> direction. Perform the following operations:&nbsp;</span></p>
...
You don't need to read input or print anything. Complete the function <strong>endPoints()</strong>&nbsp;which take the matrix as input parameter and returns the index of the last cell before exiting the matrix.&nbsp;</span></p>
