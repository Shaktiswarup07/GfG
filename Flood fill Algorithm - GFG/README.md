...
## Medium
<div class="problems_problem_content__Xm_eO" bis_skin_checked="1"><p><span style="font-size:18px">An&nbsp;<code>image</code>&nbsp;is represented by a 2-D array of integers, each integer representing the pixel value of the image.</span></p>
...
<div bis_skin_checked="1"><span style="font-size:18px"><strong>Constraints:</strong><br>
1 &lt;= n &lt;= m &lt;= 100<br>
0 &lt;= pixel values &lt;= 10</span></div>

<div bis_skin_checked="1"><span style="font-size:18px">0 &lt;= sr &lt;= (n-1)</span></div>

<div bis_skin_checked="1"><span style="font-size:18px">0 &lt;= sc &lt;= (m-1)</span></div>
</div>